...
const double q_max[7] = {100, 128.9 * DEG2RAD, 100, 147.8 * DEG2RAD, 100, 120.3 * DEG2RAD, 100};
const double q_min[7] = {-100, -128.9 * DEG2RAD, -100, -147.8 * DEG2RAD, -100, -120.3 * DEG2RAD, -100};
...
void joint_angle_limit(const Matrix<double> &q, Matrix<double> &subtasks);
